...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
iK = 14; e = zeros(T_out,iK); v = zeros(T_out,iK);
for t = 1:T_out
    ...
    e(t,13) = GMVP(GIS(X_in))'*X_out(t,:)';
    e(t,14) = GMVP(cov1Para(X_in))'*X_out(t,:)';
    ...
    v(t,13) = RPP(GIS(X_in))'*X_out(t,:)';
    v(t,14) = RPP(cov1Para(X_in))'*X_out(t,:)';
end
