function [Lambda,gamma_opt,Psi] = sparse_factor_TS(X,m,gamma,method,Lambda_init,Psi_init)
...
if nargin < 6
    [Lambda_init,Psi_init] = non_penalized_factor(X,m);
end
...
[Lambda,gamma_opt,Psi] = cv_sfm_ts(X,m,Lambda_rotated,Psi_init,gamma,method);
